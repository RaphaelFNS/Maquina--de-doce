...
<div className="sweet-buttons">
  ...
  <button
    className="warning-button"
    onClick={() => comprarDoce("B")}
    style={{ display: saldo >= DOCE_PRECOS["B"] ? "inline-block" : "none" }}
  >
    Doce B (R$7,00)
  </button>
  <button
    className="warning-button"
    onClick={() => comprarDoce("C")}
    style={{ display: saldo >= DOCE_PRECOS["C"] ? "inline-block" : "none" }}
  >
    Doce C (R$8,00)
  </button>
</div>
